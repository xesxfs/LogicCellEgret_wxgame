...
function uploadWXData(key, data) {
...
function getUserCloudStorage(keys) {
  wx.getUserCloudStorage({
    ...
    fail() {
      console.log("getUserCloudStorage失败");
    }
  })
}


function getFriendCloudStorage(keys) {
  wx.getFriendCloudStorage({
    ...
    fail() {
      console.log("getFriendCloudStorage失败");
    }
  })
}
...
wx.onMessage((data) => {
  ...
  switch (data.command) {
    case "getUserCloudStorage":
      getUserCloudStorage(data.keys)
      break;
    case "getFriendCloudStorage":
      getFriendCloudStorage(data.keys);
      break;
  }
});